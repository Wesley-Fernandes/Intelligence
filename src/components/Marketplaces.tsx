...
export default function Marketplaces() {
  return (
    <section className="py-6 bg-[#167cc0] text-white">
      <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
        <div className="flex flex-col justify-center lg:text-left">
          <p className="mb-1 text-sm font-medium tracking-widest uppercase text-white/50">
            Tenham controle total sobre a sua vida nosso app
          </p>
          <h1 className="py-2 text-3xl font-medium leading-tight title-font">
            Moradores e sindicos
          </h1>
        </div>
        <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
          <button className="inline-flex items-center px-6 py-3 rounded-lg dark:bg-blue-700 border-b-2 border-b-blue-800 dark:text-gray-50 shadow">
            <svg
            ...
            <span className="flex flex-col items-start ml-4 leading-none">
              <span className="mb-1 text-xs">Baixe agora em</span>
              <span className="font-semibold title-font">Google Play</span>
            </span>
          </button>
          <button className="inline-flex items-center px-5 py-3 rounded-lg dark:bg-blue-700 border-b-2 border-b-blue-800 dark:text-gray-50">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 50 50"
              className="fill-current w-7 h-7 dark:text-gray-50"
            ...
            <span className="flex flex-col items-start ml-4 leading-none">
              <span className="mb-1 text-xs">Faça o download na</span>
